      ...
      if(data.legend === false){
        if(el){
          ...
          if(data.updateOptions){
            ...
            if(document.getElementById("nodeSelect"+data.id).style.display === 'none'){
              updateOpts = true;
              dataOptions.id  = data.id;
              dataOptions.options.idselection = {enabled : true, useLabels : main_el.idselection_useLabels};
            }

            if(document.getElementById("selectedBy"+data.id).style.display === 'none'){
              updateOpts = true;
              dataOptions.id  = data.id;
...
HTMLWidgets.widget({
  ...
  renderValue: function(el, x, instance) {
    ...
    byList.setAttribute('class', 'display:none');
    ...
    if(el_id.byselection){
      ...
      selectList2.setAttribute('class', 'display:none');
