...
nodes <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/mynamesapce/nodes.csv'))
links <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/mynamesapce/links.csv'))
...
network <- visNetwork(nodes, links, height = "400px", width = "100%",physics=T) %>%
    ...
    visSave(network, file = "/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/mynamesapce/network.html", selfcontained = F)
    ...
    visSave(network, file = "/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/mynamesapce/network2.html", selfcontained = F)
