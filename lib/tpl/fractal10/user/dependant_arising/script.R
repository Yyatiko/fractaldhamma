...
nodes <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/nodes.csv'))
links <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/links.csv'))
...
network <- visNetwork(nodes, links, height = "400px", width = "100%",physics=T) %>%
    ...
    visOptions(highlightNearest = TRUE,
               nodesIdSelection = list(selected = "Birth"))%>%
    visLayout(randomSeed = 123)%>%
    visInteraction(dragNodes = T, dragView = FALSE, zoomView = FALSE)

    visSave(network, file = "/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/network.html", selfcontained = F)
    ...
    visSave(network, file = "/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/network2.html", selfcontained = F)
