...
mydata <- read.csv('/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/links.csv', head = T)
nodesOrigin <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/dependant_arising/nodes.csv'))
