...
mydata <- read.csv('/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/patimokkha/links.csv', head = T)
nodesOrigin <- data.frame(read.csv(file = '/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/patimokkha/nodes.csv'))
...
network <- visNetwork(nodes, edges) %>%
      ...
      visOptions(highlightNearest = TRUE,
                 nodesIdSelection = list(selected = "Pārājika"))%>%
...
visSave(network, file = "/Users/Lancelot/Sites/GitHub/fractaldhamma/lib/tpl/fractal10/user/patimokkha/network.html", selfcontained = F)
